...
@Contended
class LockfreeAtomicReadPrefilledRingBuffer<T> extends LockfreePrefilledRingBuffer<T> {
    ...
    LockfreeAtomicReadPrefilledRingBuffer(PrefilledRingBufferBuilder<T> builder) {
