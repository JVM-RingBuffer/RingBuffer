...
@Contended
class LockfreeConcurrentPrefilledRingBuffer<T> extends LockfreePrefilledRingBuffer<T> {
    ...
    LockfreeConcurrentPrefilledRingBuffer(PrefilledRingBufferBuilder<T> builder) {
