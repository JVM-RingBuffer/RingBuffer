 ...
 * {@code PaddedAbstractQueuedSynchronizer} does not implement any
 ...
 * {@code PaddedAbstractQueuedSynchronizer} method otherwise creates such a
 ...
 * using an {@code PaddedAbstractQueuedSynchronizer} for their
...
public abstract class PaddedAbstractQueuedSynchronizer extends AbstractOwnableSynchronizer implements Serializable {
    ...
    /**
     * Creates a new {@code PaddedAbstractQueuedSynchronizer} instance
     * with initial synchronization state of zero.
     */
    protected PaddedAbstractQueuedSynchronizer() {
    }
    ...
    static final class Node {
        ...
        Node(Node nextWaiter) {
            ...
            Atomic.setPlain(this, THREAD, Thread.currentThread());
        }
         ...
         */
        Node(int waitStatus) {
            AtomicInt.setPlain(this, WAITSTATUS, waitStatus);
            Atomic.setPlain(this, THREAD, Thread.currentThread());
        }
        ...
        final boolean compareAndSetWaitStatus(int expect, int update) {
            return AtomicInt.compareAndSetVolatile(this, WAITSTATUS, expect, update);
        }

        /**
         * CASes next field.
         */
        final void compareAndSetNext(Node expect, Node update) {
            Atomic.compareAndSetVolatile(this, NEXT, expect, update);
        }
        ...
        static {
            ...
            NEXT = Unsafe.objectFieldOffset(clazz, "next");
            PREV = Unsafe.objectFieldOffset(clazz, "prev");
            THREAD = Unsafe.objectFieldOffset(clazz, "thread");
            WAITSTATUS = Unsafe.objectFieldOffset(clazz, "waitStatus");
        }
    }
    ...
    protected final boolean compareAndSetState(int expect, int update) {
        return AtomicInt.compareAndSetVolatile(this, STATE, expect, update);
    }
    ...
    private Node enq(Node node) {
        for (; ; ) {
            Node oldTail = tail;
            if (oldTail != null) {
                Atomic.setPlain(node, Node.PREV, oldTail);
     ...
     * avoid <a href="PaddedAbstractQueuedSynchronizer.html#barging">barging</a>.
     ...
     */
    final boolean isNotOnSyncQueue(Node node) {
     ...
     */
    protected final boolean doesNotOwn(ConditionObject condition) {
        return condition.isNotOwnedBy(this);
    }
    ...
    /**
     * Condition implementation for a {@link PaddedAbstractQueuedSynchronizer}
     ...
     * {@code PaddedAbstractQueuedSynchronizer}.
     *
    ...
    protected class ConditionObject implements Condition, Serializable {
         ...
         * @return {@code true} if owned
         */
        final boolean isNotOwnedBy(PaddedAbstractQueuedSynchronizer sync) {
            return sync != PaddedAbstractQueuedSynchronizer.this;
        }

        /**
         * Queries whether any threads are waiting on this condition.
         * Implements {@link PaddedAbstractQueuedSynchronizer#hasWaiters(ConditionObject)}.
         *
         * @return {@code true} if there are any waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
         ...
         * this condition.
         * Implements {@link PaddedAbstractQueuedSynchronizer#getWaitQueueLength(ConditionObject)}.
         *
         * @return the estimated number of waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
         ...
         * Implements {@link PaddedAbstractQueuedSynchronizer#getWaitingThreads(ConditionObject)}.
         *
         * @return the collection of threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
    ...
    private void initializeSyncQueue() {
        Node h;
        if (Atomic.compareAndSetVolatile(this, HEAD, null, (h = new Node())))
            tail = h;
    }
    ...
    private boolean compareAndSetTail(Node expect, Node update) {
        return Atomic.compareAndSetVolatile(this, TAIL, expect, update);
    }
}
