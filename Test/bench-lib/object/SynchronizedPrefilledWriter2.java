...
class SynchronizedPrefilledWriter2 extends BenchmarkThread {
    static BenchmarkThreadGroup startGroupAsync(PrefilledRingBuffer2<Event> ringBuffer, Profiler profiler) {
        BenchmarkThreadGroup group = new BenchmarkThreadGroup(numIterations -> new SynchronizedPrefilledWriter2(numIterations, ringBuffer));
