...
public class ConcurrentPrefilledRingBufferObjectPoolBenchmark extends Benchmark {
    public static void main(String[] args) {
        new ConcurrentPrefilledRingBufferObjectPoolBenchmark().launchBenchmark();
    }

    @Override
    protected int getConcurrency() {
        return Config.ConcurrentPrefilledRingBufferObjectPoolBenchmark_concurrency;
    }
