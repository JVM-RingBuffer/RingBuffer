...
public class ProducersToProcessorToConsumersContentionBenchmark extends RingBufferBenchmark {
    ...
    public static void main(String[] args) {
        new ProducersToProcessorToConsumersContentionBenchmark().runBenchmark();
    }
