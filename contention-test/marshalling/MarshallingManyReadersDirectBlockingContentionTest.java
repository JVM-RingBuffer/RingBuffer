...
public class MarshallingManyReadersDirectBlockingContentionTest extends RingBufferTest {
    ...
    public static void main(String[] args) {
        new MarshallingManyReadersDirectBlockingContentionTest().runBenchmark();
    }
