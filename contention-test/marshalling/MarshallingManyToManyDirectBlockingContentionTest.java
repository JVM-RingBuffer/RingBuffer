...
public class MarshallingManyToManyDirectBlockingContentionTest extends RingBufferTest {
    ...
    public static void main(String[] args) {
        new MarshallingManyToManyDirectBlockingContentionTest().runBenchmark();
    }
