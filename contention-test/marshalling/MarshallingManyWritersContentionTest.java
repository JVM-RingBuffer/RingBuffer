...
public class MarshallingManyWritersContentionTest extends RingBufferTest {
    ...
    public static void main(String[] args) {
        new MarshallingManyWritersContentionTest().runBenchmark();
    }
    ...
    protected long testSum() {
        ...
        ClearingWriter.startGroupAsync(RING_BUFFER, profiler);
