...
public class MarshallingManyWritersDirectBlockingContentionTest extends RingBufferTest {
    ...
    public static void main(String[] args) {
        new MarshallingManyWritersDirectBlockingContentionTest().runBenchmark();
    }
