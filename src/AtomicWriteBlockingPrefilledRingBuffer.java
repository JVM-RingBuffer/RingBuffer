...
public class AtomicWriteBlockingPrefilledRingBuffer<T> implements PrefilledRingBuffer<T> {
    ...
    public AtomicWriteBlockingPrefilledRingBuffer(PrefilledRingBufferBuilder<T> builder) {
