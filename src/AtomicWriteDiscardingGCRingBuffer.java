...
public class AtomicWriteDiscardingGCRingBuffer<T> implements EmptyRingBuffer<T> {
    ...
    public AtomicWriteDiscardingGCRingBuffer(EmptyRingBufferBuilder<T> builder) {
