...
public class AtomicWriteDiscardingPrefilledRingBuffer<T> implements PrefilledRingBuffer<T> {
    ...
    public AtomicWriteDiscardingPrefilledRingBuffer(PrefilledRingBufferBuilder<T> builder) {
