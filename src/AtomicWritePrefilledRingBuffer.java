...
public class AtomicWritePrefilledRingBuffer<T> implements OverwritingPrefilledRingBuffer<T> {
    ...
    public AtomicWritePrefilledRingBuffer(OverwritingPrefilledRingBufferBuilder<T> builder) {
