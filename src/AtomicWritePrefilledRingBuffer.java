...
class AtomicWritePrefilledRingBuffer<T> implements OverwritingPrefilledRingBuffer<T> {
    ...
    AtomicWritePrefilledRingBuffer(OverwritingPrefilledRingBufferBuilder<T> builder) {
