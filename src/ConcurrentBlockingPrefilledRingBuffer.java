...
public class ConcurrentBlockingPrefilledRingBuffer<T> implements PrefilledRingBuffer<T> {
    ...
    public ConcurrentBlockingPrefilledRingBuffer(PrefilledRingBufferBuilder<T> builder) {
