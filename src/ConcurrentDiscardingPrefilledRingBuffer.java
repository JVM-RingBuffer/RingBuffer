...
public class ConcurrentDiscardingPrefilledRingBuffer<T> implements PrefilledRingBuffer<T> {
    ...
    public ConcurrentDiscardingPrefilledRingBuffer(PrefilledRingBufferBuilder<T> builder) {
