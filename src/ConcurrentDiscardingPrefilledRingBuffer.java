...
class ConcurrentDiscardingPrefilledRingBuffer<T> implements PrefilledRingBuffer<T> {
    ...
    ConcurrentDiscardingPrefilledRingBuffer(AbstractPrefilledRingBufferBuilder<T> builder) {
