...
public class ConcurrentPrefilledRingBuffer<T> implements OverwritingPrefilledRingBuffer<T> {
    ...
    public ConcurrentPrefilledRingBuffer(OverwritingPrefilledRingBufferBuilder<T> builder) {
