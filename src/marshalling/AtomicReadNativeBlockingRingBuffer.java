...
class AtomicReadNativeBlockingRingBuffer implements NativeBlockingRingBuffer {
    ...
    AtomicReadNativeBlockingRingBuffer(NativeBlockingRingBufferBuilder builder) {
