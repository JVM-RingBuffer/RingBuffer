...
class AtomicWriteDirectMarshallingBlockingRingBuffer implements DirectMarshallingBlockingRingBuffer {
    ...
    AtomicWriteDirectMarshallingBlockingRingBuffer(DirectMarshallingBlockingRingBufferBuilder builder) {
