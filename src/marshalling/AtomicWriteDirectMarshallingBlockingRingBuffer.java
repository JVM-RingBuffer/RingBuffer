...
class AtomicWriteDirectMarshallingBlockingRingBuffer implements DirectMarshallingRingBuffer {
    ...
    AtomicWriteDirectMarshallingBlockingRingBuffer(DirectMarshallingRingBufferBuilder builder) {
