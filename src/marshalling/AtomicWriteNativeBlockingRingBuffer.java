...
class AtomicWriteNativeBlockingRingBuffer implements NativeBlockingRingBuffer {
    ...
    AtomicWriteNativeBlockingRingBuffer(NativeBlockingRingBufferBuilder builder) {
