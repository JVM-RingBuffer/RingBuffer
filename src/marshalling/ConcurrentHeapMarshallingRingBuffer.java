...
class ConcurrentHeapMarshallingRingBuffer implements MarshallingRingBuffer {
    ...
    ConcurrentHeapMarshallingRingBuffer(HeapMarshallingRingBufferBuilder builder) {
