...
class FastAtomicWriteMarshallingRingBuffer extends FastMarshallingRingBuffer {
    ...
    FastAtomicWriteMarshallingRingBuffer(FastMarshallingRingBufferBuilder builder) {
