...
class VolatileHeapMarshallingBlockingRingBuffer implements MarshallingRingBuffer {
    ...
    VolatileHeapMarshallingBlockingRingBuffer(HeapMarshallingRingBufferBuilder builder) {
