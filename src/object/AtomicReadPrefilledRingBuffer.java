...
class AtomicReadPrefilledRingBuffer<T> implements PrefilledOverwritingRingBuffer<T> {
    ...
    AtomicReadPrefilledRingBuffer(PrefilledOverwritingRingBufferBuilder<T> builder) {
