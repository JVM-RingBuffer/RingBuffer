...
public class PaddedAtomicFloat {
    private static final VarHandle VALUE;

    static {
        try {
            VALUE = MethodHandles.lookup().findVarHandle(PaddedAtomicFloat.class, "value", float.class);
    ...
    public PaddedAtomicFloat() {
    }

    public PaddedAtomicFloat(float value) {
        this.value = value;
    }
