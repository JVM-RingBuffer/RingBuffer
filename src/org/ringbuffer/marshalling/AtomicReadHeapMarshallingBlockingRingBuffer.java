...
class AtomicReadHeapMarshallingBlockingRingBuffer implements MarshallingRingBuffer {
    ...
    AtomicReadHeapMarshallingBlockingRingBuffer(HeapMarshallingRingBufferBuilder builder) {
