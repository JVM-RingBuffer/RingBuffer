...
abstract class AtomicReadBlockingGCRingBuffer_pad0 {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;
}

abstract class AtomicReadBlockingGCRingBuffer_buf<T> extends AtomicReadBlockingGCRingBuffer_pad0 {
    final int capacity;
    ...
    AtomicReadBlockingGCRingBuffer_buf(RingBufferBuilder<T> builder) {
...
abstract class AtomicReadBlockingGCRingBuffer_pad1<T> extends AtomicReadBlockingGCRingBuffer_buf<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadBlockingGCRingBuffer_pad1(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadBlockingGCRingBuffer_read<T> extends AtomicReadBlockingGCRingBuffer_pad1<T> {
    int readPosition;
    int cachedWritePosition;

    AtomicReadBlockingGCRingBuffer_read(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadBlockingGCRingBuffer_pad2<T> extends AtomicReadBlockingGCRingBuffer_read<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadBlockingGCRingBuffer_pad2(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadBlockingGCRingBuffer_write<T> extends AtomicReadBlockingGCRingBuffer_pad2<T> {
    int writePosition;
    int cachedReadPosition;

    AtomicReadBlockingGCRingBuffer_write(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadBlockingGCRingBuffer_pad3<T> extends AtomicReadBlockingGCRingBuffer_write<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadBlockingGCRingBuffer_pad3(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

class AtomicReadBlockingGCRingBuffer<T> extends AtomicReadBlockingGCRingBuffer_pad3<T> implements RingBuffer<T> {
    private static final long READ_POSITION, WRITE_POSITION;

    static {
        READ_POSITION = Unsafe.objectFieldOffset(AtomicReadBlockingGCRingBuffer_read.class, "readPosition");
        WRITE_POSITION = Unsafe.objectFieldOffset(AtomicReadBlockingGCRingBuffer_write.class, "writePosition");
    }
