...
abstract class AtomicReadBlockingRingBuffer_pad0 {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;
}

abstract class AtomicReadBlockingRingBuffer_buf<T> extends AtomicReadBlockingRingBuffer_pad0 {
    final int capacity;
    ...
    AtomicReadBlockingRingBuffer_buf(RingBufferBuilder<T> builder) {
...
abstract class AtomicReadBlockingRingBuffer_pad1<T> extends AtomicReadBlockingRingBuffer_buf<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadBlockingRingBuffer_pad1(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadBlockingRingBuffer_read<T> extends AtomicReadBlockingRingBuffer_pad1<T> {
    int readPosition;
    int cachedWritePosition;

    AtomicReadBlockingRingBuffer_read(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadBlockingRingBuffer_pad2<T> extends AtomicReadBlockingRingBuffer_read<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadBlockingRingBuffer_pad2(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadBlockingRingBuffer_write<T> extends AtomicReadBlockingRingBuffer_pad2<T> {
    int writePosition;
    int cachedReadPosition;

    AtomicReadBlockingRingBuffer_write(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadBlockingRingBuffer_pad3<T> extends AtomicReadBlockingRingBuffer_write<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadBlockingRingBuffer_pad3(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

class AtomicReadBlockingRingBuffer<T> extends AtomicReadBlockingRingBuffer_pad3<T> implements RingBuffer<T> {
    private static final long READ_POSITION, WRITE_POSITION;

    static {
        READ_POSITION = Unsafe.objectFieldOffset(AtomicReadBlockingRingBuffer_read.class, "readPosition");
        WRITE_POSITION = Unsafe.objectFieldOffset(AtomicReadBlockingRingBuffer_write.class, "writePosition");
    }
