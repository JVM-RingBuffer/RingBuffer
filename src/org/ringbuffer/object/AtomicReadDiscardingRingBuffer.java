...
abstract class AtomicReadDiscardingRingBuffer_pad0 {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;
}

abstract class AtomicReadDiscardingRingBuffer_buf<T> extends AtomicReadDiscardingRingBuffer_pad0 {
    final int capacity;
    ...
    AtomicReadDiscardingRingBuffer_buf(RingBufferBuilder<T> builder) {
...
abstract class AtomicReadDiscardingRingBuffer_pad1<T> extends AtomicReadDiscardingRingBuffer_buf<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadDiscardingRingBuffer_pad1(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadDiscardingRingBuffer_read<T> extends AtomicReadDiscardingRingBuffer_pad1<T> {
    int readPosition;
    int cachedWritePosition;

    AtomicReadDiscardingRingBuffer_read(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadDiscardingRingBuffer_pad2<T> extends AtomicReadDiscardingRingBuffer_read<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadDiscardingRingBuffer_pad2(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadDiscardingRingBuffer_write<T> extends AtomicReadDiscardingRingBuffer_pad2<T> {
    int writePosition;
    int cachedReadPosition;

    AtomicReadDiscardingRingBuffer_write(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicReadDiscardingRingBuffer_pad3<T> extends AtomicReadDiscardingRingBuffer_write<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicReadDiscardingRingBuffer_pad3(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

class AtomicReadDiscardingRingBuffer<T> extends AtomicReadDiscardingRingBuffer_pad3<T> implements RingBuffer<T> {
    private static final long READ_POSITION, WRITE_POSITION;

    static {
        READ_POSITION = Unsafe.objectFieldOffset(AtomicReadDiscardingRingBuffer_read.class, "readPosition");
        WRITE_POSITION = Unsafe.objectFieldOffset(AtomicReadDiscardingRingBuffer_write.class, "writePosition");
    }
