...
abstract class AtomicWriteDiscardingGCRingBuffer_pad0 {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;
}

abstract class AtomicWriteDiscardingGCRingBuffer_buf<T> extends AtomicWriteDiscardingGCRingBuffer_pad0 {
    final int capacity;
    ...
    AtomicWriteDiscardingGCRingBuffer_buf(RingBufferBuilder<T> builder) {
...
abstract class AtomicWriteDiscardingGCRingBuffer_pad1<T> extends AtomicWriteDiscardingGCRingBuffer_buf<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicWriteDiscardingGCRingBuffer_pad1(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicWriteDiscardingGCRingBuffer_read<T> extends AtomicWriteDiscardingGCRingBuffer_pad1<T> {
    int readPosition;
    int cachedWritePosition;

    AtomicWriteDiscardingGCRingBuffer_read(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicWriteDiscardingGCRingBuffer_pad2<T> extends AtomicWriteDiscardingGCRingBuffer_read<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicWriteDiscardingGCRingBuffer_pad2(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicWriteDiscardingGCRingBuffer_write<T> extends AtomicWriteDiscardingGCRingBuffer_pad2<T> {
    int writePosition;
    int cachedReadPosition;

    AtomicWriteDiscardingGCRingBuffer_write(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class AtomicWriteDiscardingGCRingBuffer_pad3<T> extends AtomicWriteDiscardingGCRingBuffer_write<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    AtomicWriteDiscardingGCRingBuffer_pad3(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

class AtomicWriteDiscardingGCRingBuffer<T> extends AtomicWriteDiscardingGCRingBuffer_pad3<T> implements RingBuffer<T> {
    private static final long READ_POSITION, WRITE_POSITION;

    static {
        READ_POSITION = Unsafe.objectFieldOffset(AtomicWriteDiscardingGCRingBuffer_read.class, "readPosition");
        WRITE_POSITION = Unsafe.objectFieldOffset(AtomicWriteDiscardingGCRingBuffer_write.class, "writePosition");
    }
