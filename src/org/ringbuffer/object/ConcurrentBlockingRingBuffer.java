...
abstract class ConcurrentBlockingRingBuffer_pad0 {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;
}

abstract class ConcurrentBlockingRingBuffer_buf<T> extends ConcurrentBlockingRingBuffer_pad0 {
    final int capacity;
    ...
    ConcurrentBlockingRingBuffer_buf(RingBufferBuilder<T> builder) {
...
abstract class ConcurrentBlockingRingBuffer_pad1<T> extends ConcurrentBlockingRingBuffer_buf<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    ConcurrentBlockingRingBuffer_pad1(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class ConcurrentBlockingRingBuffer_read<T> extends ConcurrentBlockingRingBuffer_pad1<T> {
    int readPosition;
    int cachedWritePosition;

    ConcurrentBlockingRingBuffer_read(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class ConcurrentBlockingRingBuffer_pad2<T> extends ConcurrentBlockingRingBuffer_read<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    ConcurrentBlockingRingBuffer_pad2(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class ConcurrentBlockingRingBuffer_write<T> extends ConcurrentBlockingRingBuffer_pad2<T> {
    int writePosition;
    int cachedReadPosition;

    ConcurrentBlockingRingBuffer_write(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

abstract class ConcurrentBlockingRingBuffer_pad3<T> extends ConcurrentBlockingRingBuffer_write<T> {
    long p000, p001, p002, p003, p004, p005, p006, p007;
    long p008, p009, p010, p011, p012, p013, p014, p015;

    ConcurrentBlockingRingBuffer_pad3(RingBufferBuilder<T> builder) {
        super(builder);
    }
}

class ConcurrentBlockingRingBuffer<T> extends ConcurrentBlockingRingBuffer_pad3<T> implements RingBuffer<T> {
    private static final long READ_POSITION, WRITE_POSITION;

    static {
        READ_POSITION = Unsafe.objectFieldOffset(ConcurrentBlockingRingBuffer_read.class, "readPosition");
        WRITE_POSITION = Unsafe.objectFieldOffset(ConcurrentBlockingRingBuffer_write.class, "writePosition");
    }
