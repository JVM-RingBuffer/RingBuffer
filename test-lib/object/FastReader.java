...
class FastReader extends TestThread implements AbstractReader {
    static long runGroupAsync(FastEmptyRingBuffer<Event> ringBuffer, Profiler profiler) {
    ...
    static long runAsync(int numIterations, FastEmptyRingBuffer<Event> ringBuffer, Profiler profiler) {
    ...
    FastReader(int numIterations, FastEmptyRingBuffer<Event> ringBuffer) {
