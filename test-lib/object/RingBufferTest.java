...
abstract class RingBufferTest extends AbstractRingBufferTest {
    ...
    static final int FAST_ONE_TO_ONE_SIZE = Numbers.getNextPowerOfTwo(ONE_TO_ONE_SIZE);
    static final int FAST_NOT_ONE_TO_ONE_SIZE = Numbers.getNextPowerOfTwo(NOT_ONE_TO_ONE_SIZE);
